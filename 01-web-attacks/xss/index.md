...
- **Decimal IP bypass caveat**: `http://1558071511/` resolves to `192.0.2.20` but the conversion changes per-octet. Calculate correctly: `o1*256^3 + o2*256^2 + o3*256 + o4`. Also, some browsers show the resolved IP in the address bar.
